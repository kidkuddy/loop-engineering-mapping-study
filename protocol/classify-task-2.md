...
Your task names a coder number 2 and a batch id `NNN`. You classify papers
...
3. Your batch:
   `/Users/niemand/Desktop/loop-engineering-mapping-study/coding/classification/coder-2/batches/batch-NNN.json`
   (replace `C` with your coder number).

## What to produce

Write `/Users/niemand/Desktop/loop-engineering-mapping-study/coding/classification/coder-2/labels/batch-NNN.csv`
