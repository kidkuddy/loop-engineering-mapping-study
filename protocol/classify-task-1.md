...
Your task names a coder number 1 and a batch id `NNN`. You classify papers
...
3. Your batch:
   `/Users/niemand/Desktop/loop-engineering-mapping-study/coding/classification/coder-1/batches/batch-NNN.json`
   (replace `C` with your coder number).

## What to produce

Write `/Users/niemand/Desktop/loop-engineering-mapping-study/coding/classification/coder-1/labels/batch-NNN.csv`
